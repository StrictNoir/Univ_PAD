...
redis_url = ENV['REDIS_URL'] || cfg['redis_url']
redis_prefix = ENV['REDIS_STREAM_PREFIX'] || cfg['redis_stream_prefix'] || 'stream:messages:'

raise 'REDIS_URL must be configured for the broker' unless redis_url
